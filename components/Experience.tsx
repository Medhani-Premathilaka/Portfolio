      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-2">
        <div className="flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            <h3 className="text-xl font-bold text-letters">
              {title}
            </h3>
            {ongoing && (
        ...
        <div className="flex items-center gap-1 text-slate-500 text-sm mt-2 md:mt-0">
          <Calendar size={14} />
          <span>{period}</span>
        </div>
      </div>
...
'Strengthened problem-solving skills and ability to work efficiently under pressure'
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold text-letters mb-2 text-center">Experience</h2>
